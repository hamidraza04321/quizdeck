...
<div class="page-breadcrumb">
  <div class="row">
    <div class="col-12 d-flex no-block align-items-center">
      <h4 class="page-title">View Paper</h4>
		        ...
		        <div class="content clearfix">
		        	<section id="steps-uid-0-p-0" role="tabpanel" aria-labelledby="steps-uid-0-h-0" class="body current" aria-hidden="false">
		          		<table class="table table-bordered bg-white br-20">
		          			<thead>
		          				<tr>
		          					<td style="width: 50%;"><strong>Subject</strong></td>
		          					<td style="width: 50%;">{{ $paper->subject->name }}</td>
		          				</tr>
		          			</thead>
                            <tbody>
                            	<tr>
                            	...
                            	<tr>
		          					<td><strong>Number Of Students with This Test</strong></td>
