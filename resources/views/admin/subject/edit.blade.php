...
<div class="container-fluid">
  ...
  <div class="card">
    <div class="card-body wizard-content">
      <form action="{{ route('subject.update', $subject->id) }}" enctype="multipart/form-data" method="post">
      	@csrf
      	@method('PUT')
        ...
        <div class="content clearfix">
          <section id="steps-uid-0-p-0" role="tabpanel" aria-labelledby="steps-uid-0-h-0" class="body current" aria-hidden="false">
            ...
            @enderror
            <input id="name" name="name" type="text" value="{{ $subject->name }}" class="required form-control @error('name') error @enderror" value="{{ old('name') }}">
	        ...
	        <div class="form-group">
	        	<img src="/images/{{ $subject->image }}" id="img">
	        </div>
